...
class Mapel extends Backend_Controller {
	...
	public function tambah(){
		$this->form_validation->set_rules('data_sekolah_id', 'Sekolah ID', 'required');
		$this->form_validation->set_rules('nama', 'Nama Mata Pelajaran', 'required');
		$this->form_validation->set_rules('data_rombel_id', 'Rombel', 'required');
		$this->form_validation->set_rules('guru_id', 'Guru Mata Pelajaran', 'required');
