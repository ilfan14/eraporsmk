<?php
class Kompetensi extends Backend_Controller {
	...
	public function index(){
		...
		foreach($masukkan as $k=>$v){
			$a = $this->bidang_keahlian->find_by_nama($v['bidang_keahlian']);
			if(!$a){
				$inser_data = bidang_keahlian->insert(array('nama' => $v['bidang_keahlian']));
				if($inser_data){
					$disimpan++;
				} else {
