...
<div class="row">
		...
		<div class="col-xs-6">
            ...
            <label>Status Kepegawaian</label>
                <div class="well well-sm no-shadow" style="margin-top: 10px;">
                   <?php echo (isset($user)) ? get_status_kepegawaian($user->status_kepegawaian_id) : '-'; ?>
                </div>
            <label>Jenis PTK</label>
                <div class="well well-sm no-shadow" style="margin-top: 10px;">
                   <?php echo (isset($user)) ? get_jenis_ptk($user->jenis_ptk): '-'; ?>
                </div>
            <label>Agama</label>
                <div class="well well-sm no-shadow" style="margin-top: 10px;">
                   <?php echo (isset($user)) ? get_agama($user->agama_id) : '-'; ?>
                </div>
            <label>Alamat</label>
                <div class="well well-sm no-shadow" style="margin-top: 10px;">
