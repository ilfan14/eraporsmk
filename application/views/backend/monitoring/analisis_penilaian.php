<?php
$rencana_penilaian = $this->rencana_penilaian->get($rencana_id);
if($rencana_penilaian){
	$nilai_siswa = $this->nilai->find_all_by_rencana_penilaian_id($rencana_penilaian->id);
	$nama_penilaian = $rencana_penilaian->nama_penilaian;
	$n_s_final = 0;
	foreach($nilai_siswa as $set_nilai){
		$set_nilai_siswa[] = $set_nilai->nilai;
		$n_s_final += $set_nilai->nilai / count($nilai_siswa); 
		$nilai_value[$set_nilai->siswa_id] = number_format($set_nilai->nilai,0);
	}
}
...
<table class="table table-bordered table-striped">
	...
	<tr>
		...
		<td><?php echo get_nama_mapel($mapel_id); ?></td>
	</tr>
	<tr>
		<td>Penilaian</td>
		<td class="text-center">:</td>
	...
	<tr>
		...
		<td class="text-center">:</td>
		<td><?php echo $rencana_penilaian->bobot; ?></td>
	</tr>
</table>
</div>
<div class="col-sm-9">
