<?php
$ajaran = get_ta();
$all_mulok = Mulok::find_all_by_ajaran_id($ajaran->id);
if($all_mulok){
	foreach($all_mulok as $mulok){
		$guru_mulok[] = $mulok->guru_id;
	}
} else {
	$guru_mulok = '';
}
...
<aside class="main-sidebar">              
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
			<li class="header">Periode Aktif : <?php echo $ajaran->tahun.' SMT '.$ajaran->smt;?></li>
			...
			<li class="treeview <?php echo (isset($activemenu) && $activemenu == 'referensi') ?  'active' : ''; ?>">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
					...
					<?php if(is_array($guru_mulok) && in_array($loggeduser->data_guru_id,$guru_mulok)){?>
					<li<?php echo (isset($activemenu) && $activemenu == 'referensi' && 
			...
			<li class="treeview <?php echo (isset($activemenu) && $activemenu == 'monitoring') ?  'active' : ''; ?>">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
					...
					<li<?php echo (isset($activemenu) && $activemenu == 'laporan' && isset($uri[3]) && $uri[3] == 'rapor') ?  ' class="active"' : ''; ?>>
						<a href="<?php echo site_url('admin/monitoring/rapor'); ?>"><i class="fa fa-hand-o-right"></i> Monitoring Nilai Rapor</a>
					</li>
