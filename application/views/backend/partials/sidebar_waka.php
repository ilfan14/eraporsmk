			...
			<li class="treeview <?php echo (isset($activemenu) && $activemenu == 'referensi') ?  'active' : ''; ?>">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
					<li<?php echo (isset($activemenu) && $activemenu == 'referensi' && isset($uri[2]) && $uri[2] == 'data_siswa') ?  ' class="active"' : ''; ?>>
        		        <a href="<?php echo site_url('admin/data_siswa'); ?>">
                	    <i class="fa fa-hand-o-right"></i> <span>Referensi Siswa</span>
		                </a>
        		    </li>
					<li<?php echo (isset($activemenu) && $activemenu == 'referensi' && isset($uri[2]) && $uri[2] == 'data_guru') ?  ' class="active"' : ''; ?>>
			...
			<li class="treeview <?php echo (isset($activemenu) && $activemenu == 'penilaian') ?  'active' : ''; ?>">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
					...
					<li<?php echo (isset($activemenu) && $activemenu == 'penilaian' && isset($uri[3]) && $uri[3] == 'pengetahuan' || 
					isset($uri[3]) && $uri[3] == 'add_pengetahuan') ?  ' class="active"' : ''; ?>>
						<a href="<?php echo site_url('admin/asesmen/pengetahuan'); ?>"><i class="fa fa-hand-o-right"></i> Penilaian Pengetahuan</a>
					</li>
					<li<?php echo (isset($activemenu) && $activemenu == 'penilaian' && isset($uri[3]) && $uri[3] == 'keterampilan' || 
					isset($uri[3]) && $uri[3] == 'add_keterampilan') ?  ' class="active"' : ''; ?>>
					...
					<li<?php echo (isset($activemenu) && $activemenu == 'penilaian' && isset($uri[3]) && $uri[3] == 'ppk') ?  ' class="active"' : ''; ?>>
						<a href="<?php echo site_url('admin/asesmen/ppk'); ?>"><i class="fa fa-hand-o-right"></i> <span>Karakter</span> <span class="pull-right-container">
			...
			<li class="treeview <?php echo (isset($activemenu) && $activemenu == 'laporan') ?  'active' : ''; ?>">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
					...
					<li<?php echo (isset($activemenu) && $activemenu == 'laporan' && isset($uri[3]) && $uri[3] == 'deskripsi_sikap') ?  ' class="active"' : ''; ?>>
						<a href="<?php echo site_url('admin/laporan/deskripsi_sikap'); ?>"><i class="fa fa-hand-o-right"></i> Deskripsi Sikap</a>
					</li>
