...
<div class="box box-info">
    <div class="box-body">
		<!-- form start -->
			...
			//$all_jurusan = $this->jurusan_sp->get_all();
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-5">
                    <select name="kelas" class="select2 form-control" id="kelas" required>
						...
						<option value="<?php echo $rombel->id; ?>"<?php echo (isset($tingkat)) ? ($tingkat == $rombel->id ? ' selected="selected"' : '') : ''; ?>><?php echo $rombel->nama; ?></option>
						<?php } ?>
					</select>
                  </div>
                </div>
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-5">
                    <select name="mapel_id" class="select2 form-control" id="mapel" required>
						...
						?>
						<option value="<?php echo $m->mata_pelajaran_id; ?>"<?php echo (isset($mapel_id)) ? ($m->mata_pelajaran_id == $mapel_id ? ' selected="selected"' : '') : ''; ?>><?php echo get_nama_mapel($m->mata_pelajaran_id).' ('.$m->mata_pelajaran_id.')'; ?></option>						
						<?php } ?>
						<?php } ?>
					</select>
                  </div>
