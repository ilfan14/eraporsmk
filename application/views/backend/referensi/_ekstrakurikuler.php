		...
		<!-- form start -->
			...
			$tahun_ajaran = $ajaran->tahun. ' (SMT '. $ajaran->semester.')';?>
              <div class="box-body">
				...
				<div class="form-group">
                  <label for="guru" class="col-sm-2 control-label">Nama Pembina</label>
				  <div class="col-sm-5">
				...
				<div class="form-group">
				  ...
				  <div class="col-sm-5">
                    <input type="text" id="autocomplete" data-url="<?php echo site_url('admin/ajax/get_all_siswa');?>" name="nama_ketua" class="form-control" value="<?php echo (isset($data)) ? $data->nama_ketua : ''; ?>" />
                  </div>
                </div>
				<div class="form-group">
