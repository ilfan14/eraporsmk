				...
				<table class="table table-bordered table-hover">
					<thead>
						<tr>
							...
							<th width="30%">Catatan Sikap</th>
							<th width="25%">Deskripsi Sikap Spiritual</th>
							<th width="25%">Deskripsi Sikap Sosial</th>
						</tr>
					</thead>
					<tbody
					<?php
					...
					<tr>
						...
						if($all_sikap){
							...
							foreach($a as $b=>$c){
								echo get_nama_mapel($ajaran_id[$b],$rombel_id[$b],$b).' :<br />';
								echo '<ul>';
								foreach($c as $d){
									echo '<li>'.$d.'</li>';
								}
