<div class="col-sm-12" id="form">
	...
	<div class="form-group">
		...
		<?php
		$prakerins = $this->prakerin->find_all("semester_id = $ajaran_id AND rombongan_belajar_id = $rombel_id AND siswa_id = $siswa_id");
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
							<a title="Edit prakerin" href="<?php echo site_url('admin/laporan/edit_prakerin/'.$prakerin->id); ?>" class="btn btn-warning btn-sm toggle-modal"><i class="fa fa-pencil"></i></a>
							<a title="Hapus prakerin" href="<?php echo site_url('admin/laporan/delete_prakerin/'.$prakerin->id); ?>" class="btn btn-danger btn-sm confirm"><i class="fa fa-power-off"></i></a>
						</td>
					</tr>
					<?php
						$i++;
