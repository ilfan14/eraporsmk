		...
		<tbody>
			...
			if($data_siswa){
				foreach($data_siswa as $siswa){
					...
					$nilai_ekskul = $this->nilai_ekstrakurikuler->find("semester_id = $ajaran_id AND ekstrakurikuler_id = $ekskul_id AND rombongan_belajar_id = $rombel_id AND siswa_id = $siswa_id");
					//Nilaiekskul::find_by_ajaran_id_and_ekskul_id_and_rombel_id_and_siswa_id($ajaran_id,$ekskul_id,$rombel_id,$siswa->id);
			?>
			<tr>
				<td>
