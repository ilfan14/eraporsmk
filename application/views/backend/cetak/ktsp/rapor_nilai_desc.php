...
<table <?php echo $border; ?> class="<?php echo $class; ?>">
  ...
  <tr>
	...
	<tr>
		<td colspan="10"><b>Produktif</b></td>
	</tr>
	<?php
    if($mapel_produktif){
        $i=isset($i) ? $i : 1;
        foreach($mapel_produktif as $produktif) {
			$deskripsi_pengetahuan		= get_deskripsi_nilai($ajaran_id, $rombel_id, $produktif->mata_pelajaran_id, $s->id,1);
			$deskripsi_keterampilan		= get_deskripsi_nilai($ajaran_id, $rombel_id, $produktif->mata_pelajaran_id, $s->id,2);
		?>
		<tr>
			<td align="center" valign="top"><?php echo $i; ?></td>
			<td valign="top"><?php echo get_nama_mapel($produktif->mata_pelajaran_id); ?></td>
			<td valign="top"><?php echo $deskripsi_pengetahuan; ?></td>
			<td valign="top"><?php echo $deskripsi_keterampilan; ?></td>
		</tr>
            <?php
