  ...
  <tr>
    ...
    <?php
		...
		<tr>
			...
			<td valign="top"><?php echo get_nama_mapel($ajaran_id,$rombel_id,$mapela); ?><br /><?php echo get_guru_mapel($ajaran_id, $rombel_id, $mapela); ?></td>
	...
	<?php
		...
		<tr>
			<td align="center" valign="top"><?php echo $i; ?></td>
			<td valign="top"><?php echo get_nama_mapel($ajaran_id,$rombel_id,$mapelb); ?><br /><?php echo get_guru_mapel($ajaran_id, $rombel_id, $mapelb); ?></td>
    ...
    <?php }
		...
		<tr>
			<td align="center" valign="top"><?php echo $i; ?></td>
			<td valign="top"><?php echo get_nama_mapel($ajaran_id,$rombel_id,$mapelc); ?><br /><?php echo get_guru_mapel($ajaran_id, $rombel_id, $mapelc); ?></td>
