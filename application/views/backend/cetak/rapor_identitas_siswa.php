...
<table width="100%" id="alamat">
  ...
  <tr>
    ...
    <td style="width: 25%;padding:5px;">a. Ayah</td>
    <td style="width: 5%">:</td>
    <td style="width: 65%"><?php echo get_pekerjaan($s->kerja_ayah); ?></td>
  </tr>
  <tr>
    <td style="width: 5%;">&nbsp;</td>
    <td style="width: 25%;padding:5px;">b. Ibu</td>
    <td style="width: 5%">:</td>
    <td style="width: 65%"><?php echo get_pekerjaan($s->kerja_ibu); ?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="width: 5%">:</td>
    <td style="width: 65%"><?php echo get_pekerjaan($s->kerja_wali); ?></td>
  </tr>
</table>
<table width="100%" style="margin-top:100px;">
  <tr>
    ...
    <td style="width: 50%;padding:5px;"><?php echo $sekolah->kabupaten; ?>, <?php echo indo_date($s->diterima); ?><br />Kepala Sekolah</td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="width: 50%;padding:5px;"><?php echo get_nama_guru($sekolah->guru_id); ?><br />NIP. <?php echo get_nip_guru($sekolah->guru_id); ?></td>
  </tr>
</table>