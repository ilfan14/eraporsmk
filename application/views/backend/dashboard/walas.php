			...
			<div class="row">
				<div class="col-lg-12 col-xs-12" style="margin-bottom:20px;">
					<table class="table table-bordered table-striped table-hover datatable">
						...
						<tbody>
					<?php
					$all_mapel = $this->pembelajaran->find_all_by_rombongan_belajar_id($id_rombel);
					//("semester_id = $ajaran->id and guru_id = $user->guru_id");
					//Kurikulum::find_all_by_rombel_id($id_rombel);
					if($all_mapel){
						$count = 1;
