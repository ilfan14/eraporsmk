	...
	<div class="col-xs-12">
		<table class="table">
			<tr>
				...
				<th>Nomor Telepon</th>
				<td><?php echo (isset($siswa)) ? $siswa->no_telp: ''; ?></td>
			</tr>
			<tr>
				<th>NISN</th>
				<td><?php echo (isset($siswa)) ? $siswa->nisn: ''; ?></td>
				<th>Email</th>
				<td><?php echo (isset($siswa)) ? $siswa->email : ''; ?></td>
			</tr>
			<tr>
				<th>Nomor Induk</th>
				<td><?php echo (isset($siswa)) ? $siswa->no_induk: ''; ?></td>
				<th>Nama Ayah</th>
				<td><?php echo (isset($siswa)) ? $siswa->nama_ayah: ''; ?></td>
			</tr>
			<tr>
				<th>Jenis Kelamin</th>
				<td><?php echo (isset($siswa)) ? ($siswa->jenis_kelamin == 'L') ? 'Laki-laki' : 'Perempuan' : ''; ?></td>
				<th>Pekerjaan Ayah</th>
				<td><?php echo (isset($siswa)) ? get_pekerjaan($siswa->kerja_ayah): ''; ?></td>
			</tr>
			<tr>
				<th>Agama</th>
				<td><?php echo (isset($siswa)) ? get_agama($siswa->agama) : ''; ?></td>
				<th>Nama Ibu</th>
			...
			<tr>
				...
				<th>Pekerjaan Ibu</th>
				<td><?php echo (isset($siswa)) ? get_pekerjaan($siswa->kerja_ibu): ''; ?></td>
			</tr>
			<tr>
				<th>Kodepos</th>
				<td><?php echo (isset($siswa)) ? $siswa->kode_pos: ''; ?></td>
				<th>Pekerjaan Wali</th>
				<td><?php echo (isset($siswa)) ? get_pekerjaan($siswa->kerja_wali): ''; ?></td>
			</tr>
		</table>
	</div>
</div>