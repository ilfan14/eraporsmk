    ...
    <div class="box-body">
		<!-- form start -->
			...
			?>
			  ...
			  <div class="col-sm-8">
                <div class="form-group">
				  ...
				  <div class="col-sm-9">
				  	<input type="hidden" name="kompetensi_id" value="<?php echo $kompetensi_id; ?>" />
				...
				<div class="form-group">
                  <label for="penilaian" class="col-sm-3 control-label">Penilaian</label>
				  <div class="col-sm-9">
                    <select name="rencana_id" class="select2 form-control" id="penilaian">
			...
			<div class="box-footer table-responsive no-padding">
				...
				<a href="javascript:void(0)" class="btn btn-success" id="rerata" style="display:none;">Simpan</a>
			</div>
            <?php echo form_close();  ?>
    </div><!-- /.box-body -->
</div><!-- /.box -->
