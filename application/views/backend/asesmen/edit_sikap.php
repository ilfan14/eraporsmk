<?php
$id 			= $sikap->id;
$ajaran_id		= $sikap->semester_id;
$rombel_id		= $sikap->rombongan_belajar_id;
$mapel_id		= $sikap->mata_pelajaran_id;
...
<?php echo ($this->session->flashdata('success')) ? success_msg($this->session->flashdata('success')) : ''; ?>
				  ...
				  <div class="col-sm-4">
					...
					<input type="hidden" id="mapel_id_edit" value="<?php echo $mapel_id; ?>" />
...
$('#button_form').click(function(){
	...
	$.ajax({
		...
		type: 'post',
		data: {id:id,ajaran_id:ajaran_id,rombel_id:rombel_id,mapel_id:mapel_id,siswa_id:siswa_id,butir_sikap:butir_sikap,opsi_sikap:opsi_sikap,uraian_sikap:uraian_sikap},
