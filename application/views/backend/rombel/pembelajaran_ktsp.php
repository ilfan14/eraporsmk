...
<div class="row">
	...
	$all_mapel = $this->mata_pelajaran_kurikulum->with('mata_pelajaran')->find_all("kurikulum_id = $kurikulum_id AND tingkat_pendidikan_id = $tingkat", '*', 'kelompok_id ASC');
	?>
	...
	?>
		<tr>
			...
			<td>	<?php //echo $ajaran_aktif.'=>'.$data_rombel->id.'=>'.$mapel->mata_pelajaran_id; ?>
