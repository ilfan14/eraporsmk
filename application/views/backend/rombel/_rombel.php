				...
				<div class="row">
					...
					<div class="col-xs-6"> 
						<div class="form-group col-xs-12">
							...
							<?php
							//echo $jurusan_sp_id;
							$extra1 = 'class="select2 form-control required" id="jurusan_sp_id"';
							$default_jurusan = array(''=>'== Pilih Program Keahlian ==');
							foreach($jurusan as $jur){
								$data_jur[$jur->kurikulum_id] = get_jurusan($jur->kurikulum_id);
							}
							$set_jurusan = isset($data_jur) ? $data_jur : array();
							echo form_dropdown('jurusan_sp_id', $default_jurusan + $set_jurusan, $jurusan_sp_id, $extra1) 
							?>
						</div>
						<div class="form-group col-xs-12">
							...
							$default_kompetensi_keahlian = array(''=>'== Pilih Kurikulum ==');
							//test($kurikulum);
							//echo $kurikulum_id;
							if($kurikulum){
								foreach($kurikulum as $kur){
									$data_kur[$kur->kurikulum_id] = $kur->nama_kurikulum;
								}
							}
							$set_kurikulum = isset($data_kur) ? $data_kur : array();
							echo form_dropdown('kurikulum_id', $default_kompetensi_keahlian + $set_kurikulum, $kurikulum_id, $extra1) 
							?>
						</div>
						<?php echo form_hidden('sekolah_id', $loggeduser->sekolah_id);?>
