...
if($_POST) {
	...
	if($core->validate_post($_POST) == true){
		...
		if($db_create['success'] == false) {
			...
			$message = $core->show_message('error',"The autoload file could not be written, please chmod install/config/autoload.php file to 777");
		}
		if(!isset($message)) {
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <?php if(is_writable($db_config_path)){?>
		  ...
		  <?php 
		  		...
		  		if(isset($_GET['e'])){
		  			...
		  			if($error == 'folder'){
						...
						//$rename = rename(realpath(dirname(__FILE__)),'install_renamed');
						//print_r($rename);
	  ...
	  <p>Please make the application/config/database.php file writable. <strong>Example</strong>:<br /><br /><code>chmod 777 application/config/database.php</code></p>
	  </div>
	  <?php } ?>
	</body>
</html>