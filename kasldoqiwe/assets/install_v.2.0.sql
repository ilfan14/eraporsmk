...
--
-- Host: 127.0.0.1
-- Generation Time: 30 Apr 2017 pada 19.45
...
--
-- Struktur dari tabel `anggota_rombels`
--
...
--
-- Struktur dari tabel `catatan_walis`
--
...
--
-- Struktur dari tabel `datakurikulums`
--
...
--
-- Struktur dari tabel `data_mapels`
--
...
--
-- Struktur dari tabel `data_portofolios`
--
...
--
-- Struktur dari tabel `data_rombels`
--
...
--
-- Struktur dari tabel `data_sikaps`
--
...
CREATE TABLE `data_sikaps` (
  ...
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `ajaran_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `data_siswas` (
  ...
  `anggota_rombel_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Struktur dari tabel `deskripsis`
--
...
--
-- Struktur dari tabel `deskripsi_sikaps`
--
...
CREATE TABLE `kurikulums` (
  `id` int(11) UNSIGNED NOT NULL,
  `ajaran_id` int(11) NOT NULL,
  `data_rombel_id` int(11) NOT NULL DEFAULT '0',
  `id_mapel` varchar(255) NOT NULL,
...
--
-- Struktur dari tabel `kurikulum_aliases`
--
...
--
-- Struktur dari tabel `matpel_komps`
--
...
--
-- Struktur dari tabel `nilaiakhirs`
--
...
--
-- Struktur dari tabel `nilai_ekskuls`
--
...
--
-- Struktur dari tabel `rencana_penilaians`
--
...
--
-- Indexes for table `remedials`
--
ALTER TABLE `remedials`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `prestasis`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `remedials`
--
ALTER TABLE `remedials`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
--
